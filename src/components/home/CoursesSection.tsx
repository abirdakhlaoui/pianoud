...
const COURSES = [
  { id:"1", slug:"piano-fundamentals", instrument:"PIANO", level:"BEGINNER",     price:184, rating:4.9, students:842,  lessons:36, bestseller:true,  title_en:"Piano Fundamentals",       title_ar:"أساسيات البيانو",          instructor_en:"Ons Wafa Romdhani", instructor_ar:"أنس الوفاء رمضاني" },
  { id:"2", slug:"arabic-maqam-oud",   instrument:"OUD",   level:"INTERMEDIATE", price:259, rating:4.8, students:631,  lessons:48, bestseller:true,  title_en:"Arabic Maqam & Oud",        title_ar:"المقامات العربية والعود",  instructor_en:"Omar Algour",       instructor_ar:"عمر القور" },
  { id:"3", slug:"classical-piano",    instrument:"PIANO", level:"ADVANCED",     price:334, rating:4.7, students:412,  lessons:54, bestseller:false, title_en:"Classical Piano",           title_ar:"البيانو الكلاسيكي",        instructor_en:"Ons Wafa Romdhani", instructor_ar:"أنس الوفاء رمضاني" },
  { id:"4", slug:"oud-beginners",      instrument:"OUD",   level:"BEGINNER",     price:146, rating:4.9, students:1205, lessons:28, bestseller:true,  title_en:"Oud for Beginners",         title_ar:"العود للمبتدئين",          instructor_en:"Omar Algour",       instructor_ar:"عمر القور" },
  { id:"5", slug:"arabic-piano",       instrument:"PIANO", level:"INTERMEDIATE", price:296, rating:4.6, students:318,  lessons:42, bestseller:false, title_en:"Arabic Piano",              title_ar:"البيانو العربي",           instructor_en:"Ons Wafa Romdhani", instructor_ar:"أنس الوفاء رمضاني" },
  { id:"6", slug:"oud-advanced",       instrument:"OUD",   level:"ADVANCED",     price:371, rating:4.8, students:204,  lessons:60, bestseller:false, title_en:"Oud Advanced",              title_ar:"العود المتقدم",            instructor_en:"Omar Algour",       instructor_ar:"عمر القور" },
  { id:"7", slug:"piano-kids",         instrument:"PIANO", level:"BEGINNER",     price:120, rating:5.0, students:530,  lessons:20, bestseller:true,  title_en:"Piano KIDS",                title_ar:"البيانو للأطفال",          instructor_en:"Ons Wafa Romdhani", instructor_ar:"أنس الوفاء رمضاني" },
  { id:"8", slug:"music-reading",      instrument:"PIANO", level:"BEGINNER",     price:99,  rating:4.8, students:720,  lessons:18, bestseller:false, title_en:"Music Reading",             title_ar:"قراءة النوتة الموسيقية",   instructor_en:"Ons Wafa Romdhani", instructor_ar:"أنس الوفاء رمضاني" },
  { id:"9", slug:"oud-harmony",        instrument:"OUD",   level:"INTERMEDIATE", price:220, rating:4.7, students:280,  lessons:32, bestseller:false, title_en:"Harmony for Oud",           title_ar:"الهارموني للعود",          instructor_en:"Omar Algour",       instructor_ar:"عمر القور" },
]
...
export default function CoursesSection() {
  ...
  const filtered = filter === "ALL" ? COURSES : COURSES.filter((c: any) => c.instrument === filter)
