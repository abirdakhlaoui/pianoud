          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:32 }} className="team-grid">
            {[
              ...
              },
              {
                ...
                bio_ar:"عازف عود محترف ومدرّس بخبرة أداء في ألمانيا وسويسرا والنرويج وآيسلندا. يدرّس في العالم العربي ومتخصص في المقامات العربية والموسيقى الأندلسية وتأليف الموسيقى باستخدام Sibelius.",
