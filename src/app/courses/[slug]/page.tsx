...
const COURSES: Record<string, any> = {
  "piano-fundamentals": {
    ...
    description_en:"Piano — Core Topics: Mastering systematic piano fundamentals — building a solid scientific foundation including a comprehensive understanding of the keyboard, with correct motor and visual coordination to accelerate progress. Establishing motor technique — dedicated exercises to adjust hand and finger positioning and develop the flexibility and strength needed for smooth playing. Studying classical, Arabic, and international pieces — training on progressively leveled pieces to understand the different expressive and dynamic styles of the instrument. Developing coordination skills (playing with both hands) — well-studied academic exercises to progress gradually in level and ensure hand independence and joint playing with high rhythmic precision. Target audience: beginners wishing to learn piano on correct academic foundations, and players seeking to develop motor technique, improve sound quality, and acquire advanced sight-reading skills. To register and begin practical training, please submit your application now.",
    description_ar:"المحاور الأساسية: إتقان أساسيات البيانو المنهجية — بناء قاعدة علمية راسخة تشمل الفهم الشامل للوحة المفاتيح، والربط الحركي والبصري الصحيح لتسريع وتيرة التطور. تأسيس التكنيك الحركي — تدريبات مخصصة لضبط وضعية اليدين والأصابع، وتطوير المرونة والقوة اللازمة للعزف السلس. دراسة المقطوعات الكلاسيكية والعربيّة والعالمية — التدريب على عزف مقطوعات متدرجة المستوى لفهم الأساليب التعبيرية والديناميكية المختلفة للآلة. تطوير مهارة التآزر (عزف اليدين معاً) — تمارين مدروسة وأكاديميّة للتّقدم في المستوى تدريجيّاً وضمان استقلالية اليدين والعزف المشترك بدقة إيقاعية عالية. الفئة المستهدفة: المبتدئون الراغبون في تعلم العزف على البيانو بأسس أكاديمية صحيحة، والعازفون الساعون لتطوير التكنيك الحركي وتحسين جودة الصوت واكتساب مهارة قراءة النوتة المتقدّمة. للتسجيل وبدء التدريب العملي، يرجى تقديم طلبك الآن.",
    ...
    instrument:"PIANO", level:"BEGINNER", price:55, rating:4.9, students:842, lessons:36, duration:"12h 30m", bestseller:true,
  ...
  "arabic-maqam-oud": {
    ...
    instructor_en:"Omar Algour", instructor_ar:"عمر القور",
    ...
    instrument:"OUD", level:"INTERMEDIATE", price:55, rating:4.8, students:631, lessons:48, duration:"18h 00m", bestseller:true,
    language_en:"Arabic & English", language_ar:"عربي وإنجليزي",
    updated_en:"May 2025", updated_ar:"مايو 2025",
  ...
  "classical-piano": {
    ...
    instrument:"PIANO", level:"ADVANCED", price:55, rating:4.7, students:412, lessons:54, duration:"22h 15m", bestseller:false,
    language_en:"Arabic & English", language_ar:"عربي وإنجليزي",
    updated_en:"May 2025", updated_ar:"مايو 2025",
  ...
  "oud-beginners": {
    ...
    instrument:"OUD", level:"BEGINNER", price:55, rating:4.9, students:1205, lessons:28, duration:"9h 45m", bestseller:true,
    language_en:"Arabic & English", language_ar:"عربي وإنجليزي",
    updated_en:"May 2025", updated_ar:"مايو 2025",
  ...
  "arabic-piano": {
    ...
    instrument:"PIANO", level:"INTERMEDIATE", price:55, rating:4.6, students:318, lessons:42, duration:"16h 00m", bestseller:false,
    language_en:"Arabic & English", language_ar:"عربي وإنجليزي",
    updated_en:"May 2025", updated_ar:"مايو 2025",
  ...
  "oud-advanced": {
    ...
    instrument:"OUD", level:"ADVANCED", price:55, rating:4.8, students:204, lessons:60, duration:"25h 30m", bestseller:false,
    language_en:"Arabic & English", language_ar:"عربي وإنجليزي",
    updated_en:"May 2025", updated_ar:"مايو 2025",
  ...
  "piano-kids": {
    ...
    instrument:"PIANO", level:"BEGINNER", price:55, rating:5.0, students:530, lessons:20, duration:"7h 00m", bestseller:true,
    language_en:"Arabic & English", language_ar:"عربي وإنجليزي",
    updated_en:"May 2025", updated_ar:"مايو 2025",
  ...
  "oud-kids": {
    title_en:"Oud for Kids", title_ar:"العود للأطفال",
    description_en:"A joyful and engaging Oud adventure designed especially for children aged 5-12! Through games, melodies and creative activities, your child will fall in love with the Oud and Arabic music while building strong musical foundations from an early age.",
    description_ar:"مغامرة عود مبهجة ومشوّقة مصمّمة خصيصاً للأطفال من 5 إلى 12 سنة! من خلال الألعاب والألحان والأنشطة الإبداعية، سيقع طفلك في حبّ العود والموسيقى العربية مع بناء أسس موسيقية متينة منذ الصغر.",
    instructor_en:"Omar Algour", instructor_ar:"عمر القور",
    instructor_photo:"/omar.jpeg",
    instructor_bio_en:"Professional Oud player and instructor, experienced in teaching children with patience and a playful, creative approach.",
    instructor_bio_ar:"عازف عود محترف ومدرّس، متمرّس في تدريس الأطفال بصبر وأسلوب مرح وإبداعي.",
    instrument:"OUD", level:"BEGINNER", price:55, rating:5.0, students:410, lessons:20, duration:"7h 00m", bestseller:true,
    language_en:"Arabic & English", language_ar:"عربي وإنجليزي",
    updated_en:"May 2025", updated_ar:"مايو 2025",
    what_en:["Learn the Oud through games and fun activities","Hold and play the Oud correctly","Play simple Arabic melodies","Basic rhythm and musical coordination","Build concentration and creativity","Love Arabic music for life"],
    what_ar:["تعلّم العود عبر الألعاب والأنشطة الممتعة","حمل العود والعزف عليه بشكل صحيح","عزف ألحان عربية بسيطة","الإيقاع الأساسي والتنسيق الموسيقي","بناء التركيز والإبداع","عشق الموسيقى العربية مدى الحياة"],
    requirements_en:["Age 5-12 years","No prior experience needed","A child-sized Oud recommended","Parent or guardian support recommended"],
    requirements_ar:["العمر من 5 إلى 12 سنة","لا تحتاج خبرة مسبقة","يُنصح بعود بمقاس مناسب للأطفال","يُنصح بدعم الوالدين أو الولي"],
    for_who_en:["Children aged 5 to 12","Parents who want to introduce Arabic music to their child","Kids who love melody and rhythm","Young beginners ready for their first musical adventure"],
    for_who_ar:["الأطفال من 5 إلى 12 سنة","الآباء الراغبون في تعريف أطفالهم بالموسيقى العربية","الأطفال محبّو اللحن والإيقاع","المبتدئون الصغار المستعدون لأول مغامرة موسيقية"],
    sections:[
      { title_en:"Hello Oud! 🪕", title_ar:"!أهلاً بالعود 🪕", lessons:[
        { title_en:"Meet the Oud — Strings & Sounds",   title_ar:"تعرّف على العود — الأوتار والأصوات", duration:"8:00",  free:true  },
        { title_en:"Holding the Oud the Right Way",      title_ar:"حمل العود بالطريقة الصحيحة",         duration:"10:00", free:true  },
        { title_en:"Play a Fun Arabic Tune",             title_ar:"عزف لحن عربي ممتع",                  duration:"12:00", free:false },
        { title_en:"Music Games & Rhythm",               title_ar:"ألعاب موسيقية وإيقاع",               duration:"15:00", free:false },
      ]},
      { title_en:"Growing Musician 🌟", title_ar:"!موسيقار صغير ينمو 🌟", lessons:[
        { title_en:"First Arabic Melodies",              title_ar:"أولى الألحان العربية",              duration:"18:00", free:false },
        { title_en:"Both Hands Together",                title_ar:"كلتا اليدين معاً",                   duration:"20:00", free:false },
        { title_en:"My Favourite Tune",                  title_ar:"لحني المفضّل",                       duration:"22:00", free:false },
      ]},
    ],
    reviews:[
      { name:"Parent of Sami, age 8", name_ar:"والد سامي، 8 سنوات", rating:5, comment_en:"My son loves his Oud lessons! Omar is patient and makes every class fun and exciting.", comment_ar:"ابني يحبّ دروس العود! عمر صبور ويجعل كل حصة ممتعة ومشوّقة." },
      { name:"Parent of Nour, age 6", name_ar:"والدة نور، 6 سنوات", rating:5, comment_en:"A wonderful introduction to Arabic music for children. Highly recommended!", comment_ar:"مقدّمة رائعة للموسيقى العربية للأطفال. أنصح بها بشدّة!" },
    ],
  },
  "music-reading": {
    ...
    instrument:"PIANO", level:"BEGINNER", price:55, rating:4.8, students:720, lessons:18, duration:"6h 30m", bestseller:false,
    language_en:"Arabic & English", language_ar:"عربي وإنجليزي",
    updated_en:"May 2025", updated_ar:"مايو 2025",
  ...
  "music-theory-abrsm": {
    title_en:"Music Theory ABRSM", title_ar:"نظرية الموسيقى ABRSM",
    description_en:"Teaching music theory — analyzing symbols, how to write them, and learning Western scales and their intervals across all seven musical degrees. Studying the circle of fifths (sharps). Studying the circle of fourths (flats). Learning to write and understand the musical scale through the G, F, C, and Alto clefs. Learning to transpose notes between them using the correct registers. Studying the scientific methods for deriving the key signature on fixed, clear foundations. Knowing the major scales and their corresponding (relative) minor scales sharing the same key signature. Learning to write and understand simple, compound, and irregular meters. Learning the basics of harmony and an introduction to music composition in a scientific and academic way.",
    description_ar:"تدريس نظريّات الموسيقى: تحليل الرّموز، طريقة كتابتها وتعلّم السلالم الغربيّة وأبعادها من جميع الدّرجات الموسيقيّة السّبعة. دراسة الدّائرة الخماسيّة (الدّياز). دراسة الدّائرة الرّباعية (بيمول). تعلّم كتابة السلم الموسيقى وفهمه من خلال مفاتيح الصول والفا والدّو والآلتو. تعلّم تحويل النّوتة الموسيقيّة ما بينها باستخدام الطّبقات الصّحيحة. دراسة الطرق العلميّة لاستخراج دليل المقام بأساسات ثابتة وواضحة. معرفة السّلالم الموسيقية الكبيرة وما يتوافق معها من الصّغيرة بنفس دليل السّلم. تعلم الكتابة وفهم الأوزان البسيطة والمركّبة والعرجاء. تعلّم أساسّيات الهارموني ونبذة عن التّأليف الموسيقي بشكل علمي وأكاديمي.",
    instructor_en:"Omar Algour", instructor_ar:"عمر القور",
    instructor_photo:"/omar.jpeg",
    instructor_bio_en:"Professional Oud player, composer, and academic music instructor with extensive experience teaching music theory.",
    instructor_bio_ar:"عازف عود محترف ومؤلف ومدرّس موسيقى أكاديمي بخبرة واسعة في تدريس نظرية الموسيقى.",
    instrument:"PIANO", level:"INTERMEDIATE", price:55, rating:4.9, students:190, lessons:24, duration:"8h 30m", bestseller:false,
    language_en:"Arabic & English", language_ar:"عربي وإنجليزي",
    updated_en:"May 2025", updated_ar:"مايو 2025",
    what_en:["Analyze musical symbols and notation","Master Western scales and intervals","Understand the circle of fifths and fourths","Read G, F, C and Alto clefs","Transpose notes correctly","Derive key signatures scientifically","Major scales and their relative minors","Simple, compound and irregular meters","Basics of harmony and composition"],
    what_ar:["تحليل الرموز الموسيقية والنوتة","إتقان السلالم الغربية وأبعادها","فهم الدائرة الخماسية والرباعية","قراءة مفاتيح صول وفا ودو وآلتو","تحويل النوتة بشكل صحيح","استخراج دليل المقام علمياً","السلالم الكبيرة وما يقابلها من صغيرة","الأوزان البسيطة والمركّبة والعرجاء","أساسيات الهارموني والتأليف"],
    requirements_en:["Basic music reading recommended","Notebook and pencil","Dedication to academic study"],
    requirements_ar:["يُنصح بمعرفة أساسية بقراءة النوتة","دفتر وقلم","الالتزام بالدراسة الأكاديمية"],
    for_who_en:["Students preparing for ABRSM theory exams","Musicians wanting a solid theoretical foundation","Anyone seeking academic music theory knowledge"],
    for_who_ar:["الطلاب المحضّرون لامتحانات ABRSM النظرية","الموسيقيون الراغبون في أساس نظري متين","كل من يسعى لمعرفة نظرية موسيقية أكاديمية"],
    sections:[
      { title_en:"Foundations of Theory", title_ar:"أسس النظرية", lessons:[
        { title_en:"Musical Symbols & Notation",  title_ar:"الرموز الموسيقية والكتابة",   duration:"15:00", free:true  },
        { title_en:"Western Scales & Intervals",  title_ar:"السلالم الغربية والأبعاد",     duration:"20:00", free:false },
        { title_en:"Circle of Fifths & Fourths",  title_ar:"الدائرة الخماسية والرباعية",   duration:"22:00", free:false },
      ]},
      { title_en:"Clefs & Key Signatures", title_ar:"المفاتيح ودليل المقام", lessons:[
        { title_en:"Reading All Clefs",           title_ar:"قراءة كل المفاتيح",            duration:"18:00", free:false },
        { title_en:"Deriving Key Signatures",     title_ar:"استخراج دليل المقام",          duration:"20:00", free:false },
        { title_en:"Major & Relative Minor",      title_ar:"الكبيرة والصغيرة النسبية",     duration:"19:00", free:false },
      ]},
      { title_en:"Rhythm & Harmony", title_ar:"الإيقاع والهارموني", lessons:[
        { title_en:"Simple, Compound & Irregular Meters", title_ar:"الأوزان البسيطة والمركّبة والعرجاء", duration:"21:00", free:false },
        { title_en:"Intro to Harmony & Composition",      title_ar:"مقدمة في الهارموني والتأليف",        duration:"24:00", free:false },
      ]},
    ],
    reviews:[
      { name:"Mariem T.", name_ar:"مريم ت.", rating:5, comment_en:"Finally understood key signatures and the circle of fifths. The academic approach is excellent!", comment_ar:"أخيراً فهمت دليل المقام والدائرة الخماسية. الأسلوب الأكاديمي ممتاز!" },
      { name:"Youssef R.", name_ar:"يوسف ر.", rating:5, comment_en:"Perfect preparation for my ABRSM theory exam. Highly structured and clear.", comment_ar:"تحضير مثالي لامتحان ABRSM النظري. منظّم وواضح جداً." },
    ],
  },
  "oud-harmony": {
    ...
    instrument:"OUD", level:"INTERMEDIATE", price:55, rating:4.7, students:280, lessons:32, duration:"11h 00m", bestseller:false,
    language_en:"Arabic & English", language_ar:"عربي وإنجليزي",
    updated_en:"May 2025", updated_ar:"مايو 2025",
