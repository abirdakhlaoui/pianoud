...
const COURSES: Record<string, any> = {
  ...
  "music-theory-abrsm": {
    ...
    instructor_en:"Ons Wafa Romdhani", instructor_ar:"أنس الوفاء رمضاني",
    instructor_photo:"/ons.jpeg",
    instructor_bio_en:"Graduate of the Higher Institute of Music, specialized in music theory and musicology, with extensive experience teaching ABRSM theory.",
    instructor_bio_ar:"خريجة المعهد العالي للموسيقى، متخصصة في نظرية الموسيقى وعلومها، بخبرة واسعة في تدريس نظرية ABRSM.",
